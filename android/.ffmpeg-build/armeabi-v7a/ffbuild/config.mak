...
INSTALL_NAME_DIR=
SRC_PATH=/Volumes/homes/reallive/ffmpeg-8.0.1
SRC_LINK=src
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -Wl,--gc-sections  -Wl,--as-needed -Wl,-z,noexecstack -Wl,-rpath-link=:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil -Qunused-arguments
LDEXEFLAGS= -fPIE -pie
LDSOFLAGS=
